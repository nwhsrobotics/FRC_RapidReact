...
public class RobotAutoCommandGroupA extends SequentialCommandGroup {
  ...
  public RobotAutoCommandGroupA(DriveSubsystem driveSubsystem, VisionSubsystem visionSubsystem, ShooterSubsystem shooterSubsystem, IndexSubsystem indexSubsystem, Trajectory dTraj_1, Trajectory dTraj_2) {
    ...
    new DriveAutoCommand(driveSubsystem, dTraj_1)
